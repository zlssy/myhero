define('collision-map', function(require, exports, module){
	var Map = require('map');
	
	GameEngine.CollisionMap = GameEngine.Map.extend({
		lastSlope: 1,
		tiledef: null,
		init: function(tilesize, data, tiledef) {
			this.parent(tilesize, data);
			this.tiledef = tiledef || GameEngine.CollisionMap.defaultTileDef;
	...
	var H = 1 / 2,
		...
		SOLID = true,
		NON_SOLID = false;
	GameEngine.CollisionMap.defaultTileDef = {
		5: [0, 1, 1, M, SOLID],
		6: [0, M, 1, N, SOLID],
		7: [0, N, 1, 0, SOLID],
		3: [0, 1, 1, H, SOLID],
	...
	GameEngine.CollisionMap.staticNoCollision = {
	...
	module.exports = GameEngine.CollisionMap;
});